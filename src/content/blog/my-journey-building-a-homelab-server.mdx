...
I started looking on a local marketplace for a Raspberry Pi 5, but it was surprisingly expensive—around 120€—and I knew it wouldn't be powerful enough for my needs. Next, I explored mini PCs and found some affordable but outdated options running 6th-gen i3/i5 processors.
